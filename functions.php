...
function kish_twit_pro_add_header() {
	echo "<script type=\"text/javascript\" src=\"" . WP_PLUGIN_URL . "/kish-twit/kish-twit-pro-js.php\"></script>\n";
	echo "<script type=\"text/javascript\" src=\"" . WP_PLUGIN_URL ."/kish-twit/kish-ajax.js\"></script>\n";
	echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . get_bloginfo('wpurl') . "/wp-content/plugins/kish-twit/kish-twit-pro-style.php\" media=\"screen\"/>\n";
}
...
function kish_twit_pro_add_admin() {
	$plugin_page=add_management_page('Kish Twit', 'Kish Twit', 8, 'kish-twit', 'ktp_main_page');
...
function kish_twit_pro_print_application_registration() {
	?>
		...
		Your callback URL is <?php echo KTP_WP_URL.'/wp-content/plugins/kish-twit/oauth/callback.php';?>. Check this to <a href="http://www.kisaso.com/technology/how-to-register-your-own-twitter-application/" target="_blank">Register your own Twitter Application</a>. 
	<?php
}
...
function kish_twit_pro_follow_kishtweet() {
	...
	ktpoath();
	if(!empty($ktproselectedaccount)) {
		$user= $ktproselectedaccount[0]->ktpro_screen_name;
	}
...
function kish_twit_pro_print_bookmarklet() {?>
	...
	<p style="font-size:11px;padding:3px;margin:3px 0px 0px 0px"><a href="javascript:var d=document,w=window,e=w.getSelection,k=d.getSelection,x=d.selection,s=(e?e():(k)?k():(x?x.createRange().text:0)),f='<?php echo WP_PLUGIN_URL; ?>/kish-twit/ktpop.php',l=d.location,e=encodeURIComponent,g=f+'?u='+e(l.href)+'&t='+e(d.title)+'&s='+e(s)+'&v=2';function a(){if(!w.open(g,'t','toolbar=0,resizable=0,scrollbars=1,status=1,width=500,height=300')){l.href=g;}}a();void(0);" title="Kish Twit This">Kish Twit This</a></p>
    </div>
    <div class="ktp_featured_1">
...
function kish_twit_pro_print_account_buttons() {
	...
	<?php if(!kish_twit_pro_follow_kishtweet()) : ?>
		<span id="ktp_follow_kishpress"><input type="button" value="Follow KishPress &raquo;" class="button-secondary" onclick="kish_twit_pro_process_ajax('req=follownewuser&user=<?php echo KTP_ME; ?>&ok=yes', 'ktp_follow_kishpress', 'ktp_follow_kishpress', '<?php echo KTP_LOADER_1; ?>'); return false;"></span>
	<?php endif;
}
