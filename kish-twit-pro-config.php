...
define('KTP_LOADER_1', WP_PLUGIN_URL."/kish-twit/img/ajax-loader.gif",true);
define('KTP_XML_CACHE', WP_PLUGIN_DIR. "/kish-twit/xmlcache",true);
define('KTP_CLS_IMG',WP_PLUGIN_URL."/kish-twit/img/cls.png",true);
define('KTP_LOADER_2', WP_PLUGIN_URL."/kish-twit/img/smallloader.gif",true);
define('KTP_LOADER_BLANK', WP_PLUGIN_URL."/kish-twit/img/blank.png",true);
define('KTP_LOADER_SMALL_BLANK',WP_PLUGIN_URL."/kish-twit/img/small_blank.png",true);
define('KTP_WP_BlOG_URL', get_bloginfo('wpurl'),true);
define('KTP_ME', 'kishpress',true);
...
define('KTP_TWIT_API_URL', WP_PLUGIN_DIR.'/kish-twit/twitter_api.php',true);
define('KTP_TWIT_API_URL_2', WP_PLUGIN_DIR.'/kish-twit/twitter.lib.php',true);
define('KTP_TWIT_AJAX_URL', WP_PLUGIN_URL."/kish-twit/ktp_ajax.php",true);
define('KTP_OAUTH_DIR', WP_PLUGIN_URL."/kish-twit/oauth",true);
